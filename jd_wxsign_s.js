...
LZKJ_SEVENDAY_JF   https://lzkj-isv.isvjcloud.com/sign/sevenDay/signActivity?activityId=<活动id>
LZKJ_SIGN_JF       https://lzkj-isv.isvjcloud.com/sign/signActivity2?activityId=<活动id>
CJHY_SEVENDAY_JF   https://cjhy-isv.isvjcloud.com/sign/sevenDay/signActivity?activityId=<活动id>
CJHY_SIGN_JF       https://cjhy-isv.isvjcloud.com/sign/signActivity?activityId=<活动id>

下方例子：	单个无需 ,  多活动id用逗号分开
export LZKJ_SEVENDAY_JF="xxxx,xxxx,xxxxx"
export LZKJ_SIGN_JF="xxxx,xxxx,xxxxx"
export CJHY_SEVENDAY_JF="xxxx,xxxx,xxxxx"
export CJHY_SIGN_JF="xxxx,xxxx,xxxxx"
export jd_sevenDay_blacklist="" 黑名单 用&隔开 pin值

默认不会入会，开启请设置变量 WXSIGNRH=true;
cron: 1 1 1 1 * jd_wxsign_jf.js

*/

const $ = new Env('超级无线店铺签到（实物）');
...
const _0x3ec607 = _0x568cdc.existsSync("/ql/data/config") ? "/ql/data/config/config.sh" : "/ql/config/config.sh",
  _0x32763f = process.env.WXSIGNRH ? process.env.WXSIGNRH : false;
let _0x5903f8 = [],
  _0x470d5c = "",
  _0x427fa1 = "",
  _0x32df5e = [],
  ...
  _0x2a15ef = [],
  _0xe4722;
process.env.LZKJ_SEVENDAY_JF && process.env.LZKJ_SEVENDAY_JF != "" && (_0x32df5e = process.env.LZKJ_SEVENDAY_JF.split(",").filter(_0x2ff280 => !!_0x2ff280 && _0x2ff280.length === 32), _0x32df5e = [...new Set(_0x32df5e)]);
process.env.LZKJ_SIGN_JF && process.env.LZKJ_SIGN_JF != "" && (_0x144e4e = process.env.LZKJ_SIGN_JF.split(",").filter(_0x5acea4 => !!_0x5acea4 && _0x5acea4.length === 32), _0x144e4e = [...new Set(_0x144e4e)]);
process.env.CJHY_SEVENDAY_JF && process.env.CJHY_SEVENDAY_JF != "" && (_0x39bf25 = process.env.CJHY_SEVENDAY_JF.split(",").filter(_0x5de875 => !!_0x5de875 && _0x5de875.length === 32), _0x39bf25 = [...new Set(_0x39bf25)]);
process.env.CJHY_SIGN_JF && process.env.CJHY_SIGN_JF != "" && (_0x140e24 = process.env.CJHY_SIGN_JF.split(",").filter(_0x459112 => !!_0x459112 && _0x459112.length === 32), _0x140e24 = [...new Set(_0x140e24)]);
process.env.COOKIE_NUM && process.env.COOKIE_NUM != 10 && (_0x1937b1 = process.env.COOKIE_NUM);
