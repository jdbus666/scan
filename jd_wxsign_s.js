...
CJHY_SIGN_S   https://lzkj-isv.isvjcloud.com/sign/sevenDay/signActivity?activityId=<活动id>

下方例子：	单个无需 ,  多活动id用逗号分开
export CJHY_SIGN_S="xxxx,xxxx,xxxxx"
...
let _0x5903f8 = [],
  ...
  _0x2a15ef = [],
  _0xe4722;
process.env.CJHY_SIGN_S && process.env.CJHY_SIGN_S != "" && (_0x140e24 = process.env.CJHY_SIGN_S.split(",").filter(_0x459112 => !!_0x459112 && _0x459112.length === 32), _0x140e24 = [...new Set(_0x140e24)]);
