...
cron: 1 1 1 1 * CJHY_SIGN_JF.js

*/

const $ = new Env('CJHY_SIGN_JF');
...
let _0x5903f8 = [],
  ...
  _0x2a15ef = [],
  _0xe4722;
process.env.CJHY_SIGN_JF && process.env.CJHY_SIGN_JF != "" && (_0x32df5e = process.env.CJHY_SIGN_JF.split(",").filter(_0x2ff280 => !!_0x2ff280 && _0x2ff280.length === 32), _0x32df5e = [...new Set(_0x32df5e)]);
