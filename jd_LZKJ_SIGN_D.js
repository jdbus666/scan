...
export CJHY_SIGN_D="xxxx,xxxx,xxxxx"
export jd_sevenDay_blacklist="" 黑名单 用&隔开 pin值

默认入会，开启请设置变量 WXSIGNRH=false;
cron: 1 1 1 1 * CJHY_SIGN_D.js

*/

const $ = new Env('CJHY_SIGN_D');
...
let _0x5903f8 = [],
  ...
  _0x2a15ef = [],
  _0xe4722;
process.env.CJHY_SIGN_D && process.env.CJHY_SIGN_D != "" && (_0x32df5e = process.env.CJHY_SIGN_D.split(",").filter(_0x2ff280 => !!_0x2ff280 && _0x2ff280.length === 32), _0x32df5e = [...new Set(_0x32df5e)]);
